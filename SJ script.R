...
setwd("C:/Users/mrzsjs1/OneDrive - The University of Nottingham/RNASeq/SJ")
...
conditions = c('control', 'knockdown')
conditions = rep(conditions, each=2)
...
count_data$counts[1:4, 1:4]
counts(DESeq_dataset) [1:4, 1:4]

normalizationFactors(DESeq_dataset)
DESeq_dataset = estimateSizeFactors(DESeq_dataset)
DESeq_dataset

counts(DESeq_dataset, normalized=TRUE) [1:4, 1:4]
...
plotCounts(DESeq_dataset, gene= 'ENST00000645234.1', intgroup='conditions')
plotCounts(DESeq_dataset, gene= 'ENST00000400217.7', intgroup='conditions')
plotCounts(DESeq_dataset, gene= 'ENST00000566813.5', intgroup='conditions')
...
#save data
write.table(filter_df3, file='DETs.csv', sep ="\t", row.names = TRUE)
